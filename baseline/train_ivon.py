...
if __name__ == '__main__':
    ...
    state = create_train_state(model=model, rng=model_rng, x0 = jnp.ones([1, 32, 32, 3]), optimizer=optimizer)
    ...
    checkpoint_dir = os.path.join(script_dir, '..', 'checkpoints', 'ivon', str(args.job_id))
